...
uint256 hashGenesisBlock("0x45912d20664460d9f9f05a5f24c3dc23abb8ab8b37eb0bf2b9c0e89a79f2db6d");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // giftcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "giftcoin Signed Message:\n";
...
{
    // giftcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 200000); // giftcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 6 * 60 * 60; // giftcoin: 6 hours
static const int64 nTargetSpacing = 5 * 60; // giftcoin: 2.5 minutes
static const int64 nInterval = nTargetTimespan / nTargetSpacing;

static const int64 nTargetTimespanOld = 7 * 24 * 60 * 60; // giftcoin: 3.5 days
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    if(pindexLast->nHeight < forkBlock) {
        ...
        printf("GetNextWorkRequired RETARGET (fork at block 18252)\n");
    ...
    // giftcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // giftcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // giftcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Telegraph 18December2013 - Families to 'waste' £84m on Christmas gift cards";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1388715396;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1241986;
        ...
        assert(block.hashMerkleRoot == uint256("0x0ef2d1bf6c9de87bdbbdd9f44f6991b68ff58490284ccedd02e4af4463c83deb"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // giftcoin: increase each by adding 2 to bitcoin's value.
