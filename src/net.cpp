...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "giftcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed.giftcoin.info", "seed.giftcoin.info"},
	{"node.giftcoin.info", "node.giftcoin.info"},
    {"seedgift.poolnetwork.org", "nodegift.poolnetwork.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"seed.giftcoin.info", "node.giftcoin.info"},
    {"seedgift.poolnetwork.org", "nodegift.poolnetwork.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. giftcoin is probably already running."), addrBind.ToString().c_str());
        else
